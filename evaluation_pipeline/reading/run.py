...
def parse_args():
    ...
    parser.add_argument("--data", default="reading/data/all_measures.csv", type=pathlib.Path, help="Path to file containing the lambada dataset, we expect it to be in a JSONL format.")
